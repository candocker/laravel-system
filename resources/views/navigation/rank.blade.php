    ...
    <div class="container">
        <div class="row">
            <div class="col-sm">
                ...
                <p style="margin-top: 5px;">掌握权威、热门、优质信息，高效生活！</p></div>
            <div class="col-sm ma">
                <div class="mobimg"></div>
                <p style="margin-top: 5px;">手机扫一扫访问</p></div>
            <div class="col-sm">
                <p style="color: #555">
                    <b>相关站点</b>
                </p>
                <p style="margin-top: 5px;">
                    ...
                    <a href="http://guozhivip.com/so/" target="_blank">果汁搜索</a>
                    <br>
                    <a href="http://guozhivip.com/lab/" target="_blank">果汁实验室</a>&nbsp;
                    <a href="http://guozhivip.com/pod/" target="_blank">果汁运营</a>
                    <br>
                    <a href="http://guozhivip.com/design/" target="_blank">果汁设计</a>&nbsp;
                    <a href="http://guozhivip.com/tool/" target="_blank">果汁工具</a></p>
            </div>
            <div class="col-sm">
                <p style="color: #555">
                    <b>联系/反馈/关注</b>
                ...
                <p style="margin-top: 5px;">
                    <a href="http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=0_Hg5Obq6uXg4uuToqL9sLy_" target="_blank" title="邮箱：guozhinav@qq.com">联系</a>&nbsp;
                    <a href="https://wj.qq.com/s2/7012048/3ade/" target="_blank">合作</a>&nbsp;
                    <a href="https://support.qq.com/products/27320" target="_blank">吐个槽</a>
                    <br>
                    <a href="https://space.bilibili.com/306508238" target="_blank" title="站长B站">
                        <img src="{{$commonAssetUrl}}/nav/img/afbe0-7174.png" class="ico" alt="B站" /></a>&nbsp;&nbsp;&nbsp;
                    <a href="https://docs.qq.com/doc/DQXNORkRMT3dRcGlz" target="_blank" title="微信公众号：果汁指南">
                        <img src="{{$commonAssetUrl}}/nav/img/3bcac-5884.png" class="ico" alt="微信公众号" /></a>&nbsp;&nbsp;&nbsp;
                    <a href="https://www.zhihu.com/people/bo-he-feng-03/activities" target="_blank" title="站长知乎">
                        <img src="{{$commonAssetUrl}}/nav/img/94256-2359.png" class="ico" alt="知乎" /></a>&nbsp;&nbsp;&nbsp;
                    <a href="https://weibo.com/guozhivip?is_all=1" target="_blank" title="站长微博">
                        <img src="{{$commonAssetUrl}}/nav/img/ecd2e-8510.png" class="ico" alt="微博" /></a>&nbsp;&nbsp;&nbsp;
                    <a target="_blank" href="https://jq.qq.com/?_wv=1027&k=5kgTpGb">
                        <img border="0" src="{{$commonAssetUrl}}/nav/img/b6cba-5745.png" alt="果汁官方交流群" title="果汁交流群：245229401"></a></p>
            </div>
        </div>
    </div>
    <div class="copy">Copyright © 2016-
        <span id="showt"></span>
        <a href="http://guozhivip.com/">果汁导航</a>旗下 西安果汁简约网络科技有限公司版权所有
        <a href="http://beian.miit.gov.cn/" target="_blank">陕ICP备20012493号-2</a></div>
</div>
