...
<header class="topBar">
    ...
    <span class="header-title">书店区</span>
    ...
    <div class="footer_top">
        <ul class="inner">
            <li>
                <a href="/">
                    <div class="img_box">
                        <img src="data:image/png;base64," alt=""></div>
                    <div class="name">首页</div></a>
            </li>
            <li>
                <a href="https://m.kongfz.com/channel/1081">
                    <div class="img_box">
                        <img src="data:image/png;base64," alt=""></div>
                    <div class="name active">书店</div></a>
            </li>
            <li>
...
<div class="inner ">
  <div class="l ">
    ...
    ">
      {{? data.data[0].title || data.data[0].subTitle}}
      <div class="title ">
      ...
      {{?}}
      <div class="img_box " style=" {
        { = !data.data[0].title && !data.data[0].subTitle ? 'width:100%;height:100%;margin:0;': ''
        }
    }
    ">
        <img src=" {
    ...
    " onerror="this.style.width = 0;
    " alt="" style=" {
        { = !data.data[0].title && !data.data[0].subTitle ? 'object-fit: cover;-o-object-fit: cover;width: 100%;height: 100%;': ''
        }
    }
    ">
      </div>
  ...
  <div class="r ">
    ...
    ">
        {{? data.data[1].title || data.data[1].subTitle}}
        <div class="title ">
        ...
        {{?}}
        <div class="img_box " style=" {
        { = !data.data[1].title && !data.data[1].subTitle ? 'width:100%;height:100%;margin:0;': ''
        }
    }
    ">
          <img src=" {
    ...
    ">
        {{? data.data[2].title || data.data[2].subTitle}}
        <div class="title ">
        ...
        {{?}}
        <div class="img_box " style=" {
        { = !data.data[2].title && !data.data[2].subTitle ? 'width:100%;height:100%;margin:0;': ''
        }
    }
    ">
          <img src=" {
